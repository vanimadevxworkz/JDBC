...
public static void main(String[] args) {
		...
		try {
			...
			Query query=entityManager.createQuery("UPDATE ActorsEntity entity SET entity.name=:nameby WHERE entity.location=:locationby");
			query.setParameter("nameby", "Ambreesh" );
			query.setParameter("locationby", "mandya");
			query.executeUpdate();
