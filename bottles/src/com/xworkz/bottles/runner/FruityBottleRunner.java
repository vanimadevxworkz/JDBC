...
public class FruityBottleRunner {
	 ...
	 public static void main(String[] args) {
			...
			try(Connection connection=DriverManager.getConnection(ConnectionData.URL.getValue(), 
				...
				System.out.println("class is connectd");
					String query="insert into bottle_info values('usha',25)";
					String query1="update bottle_info set bottle_name='Usha' where bottle_name='usha'";
