...
public class PyberBottleRunner {
	 ...
	 public static void main(String[] args) {
			...
			try(Connection connection=DriverManager.getConnection(ConnectionData.URL.getValue(), 
				...
				System.out.println("class is connectd");
					String query="insert into bottle_info values('flask',30)";
					String query1="update bottle_info set bottle_name='slice' where bottle_name='flask'";
