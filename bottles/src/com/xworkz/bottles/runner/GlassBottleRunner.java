...
public class GlassBottleRunner {
	 ...
	 public static void main(String[] args) {
			...
			try(Connection connection=DriverManager.getConnection(ConnectionData.URL.getValue(), 
				...
				System.out.println("class is connectd");
					String query="insert into bottle_info values('aqua pura',50)";
					String query1="update bottle_info set bottle_name='juice bottle' where bottle_name='aqua pura'";
