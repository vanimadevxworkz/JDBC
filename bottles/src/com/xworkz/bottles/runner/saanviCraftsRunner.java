...
public class saanviCraftsRunner {
	 ...
	 public static void main(String[] args) {
			...
			try(Connection connection=DriverManager.getConnection(ConnectionData.URL.getValue(), 
				...
				System.out.println("class is connectd");
					String query="insert into bottle_info values('borosil',377)";
					String query1="update bottle_info set bottle_name='PlasticBottle' where bottle_name='borosil'";
