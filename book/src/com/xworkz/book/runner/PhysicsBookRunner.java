...
public class PhysicsBookRunner {
	...
	public static void main(String[] args) {
		try(Connection connection=DriverManager.getConnection( ConnectionData.URL.getValue(),
				...
				Statement statment=connection.createStatement()){
					...
					String query="insert into book_details values('ramayana','valmiki')";
					String query1="update book_details set book_name='Ramayana' where book_name='ramayana' ";
