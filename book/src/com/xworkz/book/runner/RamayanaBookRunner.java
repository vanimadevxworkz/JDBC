...
public class RamayanaBookRunner {
	...
	public static void main(String[] args) {
		try(Connection connection=DriverManager.getConnection( ConnectionData.URL.getValue(),
				...
				Statement statment=connection.createStatement()){
					...
					String query="insert into book_details values('mahabhart','vedavysa')";
					String query1="update book_details set book_name='Mahabharta' where book_name='mahabhart' ";
