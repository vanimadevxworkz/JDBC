	...
	public static void main(String[] args) {
		try(Connection connection=DriverManager.getConnection( ConnectionData.URL.getValue(),
				...
				Statement statment=connection.createStatement()){
					...
					String query="insert into book_details values('a place called home','preetiShetty')";
					String query1="update book_details set book_name='java' where book_name='a place called home' ";
