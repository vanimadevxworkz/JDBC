	...
	public static void main(String[] args) {
		try(Connection connection=DriverManager.getConnection( ConnectionData.URL.getValue(),
				...
				Statement statment=connection.createStatement()){
					...
					String query="insert into book_details values('the indian story','bimal jalal')";
					String query1="update book_details set book_name='story book' where book_name='the indian story' ";
