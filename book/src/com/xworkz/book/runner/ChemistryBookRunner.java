...
public class ChemistryBookRunner {
	...
	public static void main(String[] args) {
		try(Connection connection=DriverManager.getConnection( ConnectionData.URL.getValue(),
				...
				Statement statment=connection.createStatement()){
					...
					String query="insert into book_details values('Beyond 2021','mamata')";
					String query1="update book_details set book_name='Chemistry' where book_name='Beyond 2021' ";
